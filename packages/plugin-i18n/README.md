...
- `registerGlobalOptionResources: (option: string, resources: Record<string, string>) => void`: Register global option resources. If your global option description need the localization, you can install resource of it at `exntesion` or `onExtension` hook
