...
When the loader returns a Command object, Gunshi resolves the command from both the loaded command and the definition passed as the second parameter of `lazy`:
