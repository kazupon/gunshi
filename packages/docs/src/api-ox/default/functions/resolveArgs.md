...
| Name                 | Description                                                                                                  |
| -------------------- | ------------------------------------------------------------------------------------------------------------ |
| `A` _extends_ `Args` | [Arguments](/api-ox/default/interfaces/Args.md), which is an object that defines the command line arguments. |
...
| `tokens`      | `ArgToken[]`  | An array of [tokens](/api-ox/default/interfaces/ArgToken.md).                           |
