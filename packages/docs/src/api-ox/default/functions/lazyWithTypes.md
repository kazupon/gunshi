...
<p>Define a <a href="/api-ox/default/type-aliases/LazyCommand.md">lazy command</a> with specific type parameters.</p>
...
<div class="ox-api-entry__return">
  ...
  NormalizeToGunshiParams&lt;G&gt;
&gt;</code>
  <p class="ox-api-entry__return-description">A function that takes a lazy command definition via <a href="/api-ox/default/functions/lazy.md">lazy</a></p>
</div>
</div>
