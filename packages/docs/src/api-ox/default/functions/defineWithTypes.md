...
| Name                                   | Description                                                       |
| -------------------------------------- | ----------------------------------------------------------------- |
| `G` _extends_ `GunshiParamsConstraint` | A [GunshiParams](/api-ox/default/interfaces/GunshiParams.md) type |

## Returns

`DefineWithTypesReturn< ExtractExtensions<G>, ExtractArgs<G> >` — A function that takes a command definition via [define](/api-ox/default/functions/define.md)
