...
<h4>Tags</h4>
<ul class="ox-api-entry__tags"><li><span class="ox-api-entry__tag-name">@typeParam</span><span class="ox-api-entry__tag-value">T - <a href="/api-ox/definition/interfaces/Args.md">Arguments</a> which is an object that defines the command line arguments.</span></li></ul>
</div>
</div>
