...
<tr id="method-addglobaloption">
  ...
  <td><div class="ox-api-entry__member-description">Add a global option.</div><ul class="ox-api-entry__member-params"><li><code>name</code> An option name</li><li><code>schema</code> An <a href="/api-ox/plugin/interfaces/ArgSchema.md"><code>ArgSchema</code></a> for the option</li></ul></td>
</tr>
