...
<div id="pluginwithoutextension" class="ox-api-entry ox-api-entry--page">
...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/kazupon/gunshi/blob/main/packages/gunshi/src/plugin/core.ts#L298-L313" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
...
<h4>Tags</h4>
<ul class="ox-api-entry__tags"><li><span class="ox-api-entry__tag-name">@typeParam</span><span class="ox-api-entry__tag-value">E - A type extending <a href="/api-ox/plugin/interfaces/GunshiParams.md">GunshiParams</a> to specify the shape of <a href="/api-ox/plugin/interfaces/CommandContext.md"><code>CommandContext</code></a>&#39;s extensions.</span></li></ul>
</div>
</div>
