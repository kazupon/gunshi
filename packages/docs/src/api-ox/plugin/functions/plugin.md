...
<p class="ox-api-entry__source"><a class="ox-api-entry__source-link" href="https://github.com/kazupon/gunshi/blob/main/packages/gunshi/src/plugin/core.ts#L406-L465" target="_blank" rel="noopener noreferrer">View source<span class="ox-api-entry__source-icon" aria-hidden="true"></span></a></p>
...
<li class="ox-api-entry__param">
  ...
  <p class="ox-api-entry__param-description"><a href="/api-ox/plugin/interfaces/PluginOptions.md"><code>plugin options</code></a> — optional · default: {}</p>
</li>
</ul>
</div>
