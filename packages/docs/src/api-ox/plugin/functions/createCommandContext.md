...
| ------- | ---------------------------------- | ---------------------------------------------------------------------------------------------- |
| `param` | `CommandContextParams<G, V, C, E>` | A [parameters](/api-ox/plugin/interfaces/CommandContextParams.md) to create a command context. |

## Returns

`Promise<CommandContextResult<G, E>>` — A [command context](/api-ox/plugin/interfaces/CommandContext.md), which is readonly.
