...
<li class="ox-api-entry__param">
  ...
  <p class="ox-api-entry__param-description">A <a href="/api-ox/plugin/interfaces/PluginContext.md"><code>PluginContext</code></a>.</p>
</li>
</ul>
</div>
...
<div class="ox-api-entry__return">
  ...
  <p class="ox-api-entry__return-description">An <a href="/api-ox/plugin/type-aliases/Awaitable.md"><code>Awaitable</code></a> that resolves when the plugin is loaded.</p>
</div>
</div>
