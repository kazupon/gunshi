...
| `D` _extends_ [`string`](/api-ox/combinators/functions/string.md) | The description string literal type. |
...
[`CombinatorSchema`](/api-ox/combinators/type-aliases/CombinatorSchema.md)\<`T`\> & `CombinatorDescribe`\<`D`\> — A new schema with the description set.
